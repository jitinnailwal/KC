...
const services = [
  { title: 'SEO Services', description: 'Dominate Delhi search results with data-driven SEO strategies tailored for the competitive NCR market.' },
  { title: 'Social Media Marketing', description: 'Build a powerful social presence that resonates with Delhi\'s diverse and digitally-savvy audience.' },
  { title: 'Google Ads', description: 'Targeted PPC campaigns designed to capture high-intent customers across Delhi and NCR.' },
  { title: 'Content Marketing', description: 'Engaging content strategies that establish your brand authority in the Delhi market.' },
  { title: 'Website Development', description: 'Modern, high-performance websites built to convert Delhi\'s online audience into loyal customers.' },
  { title: 'WhatsApp Marketing', description: 'Direct engagement with your Delhi customer base through strategic WhatsApp campaigns.' },
];

const highlights = [
  { title: 'Deep Local Expertise', description: 'Our team understands Delhi\'s diverse market dynamics, consumer behavior, and competitive landscape across all major sectors.' },
  { title: 'NCR-Wide Reach', description: 'We help businesses expand their digital footprint across Delhi, Noida, Gurgaon, and the entire NCR region.' },
  { title: 'Proven Track Record', description: 'We have successfully helped Delhi-based businesses achieve measurable growth in organic traffic, leads, and revenue.' },
];
      ...
      <div>
          ...
          <div className="max-w-4xl mx-auto text-center relative z-10">
            ...
            <h1 className="font-heading font-bold text-3xl sm:text-4xl md:text-5xl lg:text-7xl tracking-tight mb-6">
              ...
              <span className="text-gradient">
                <AnimatedText text="Agency in Delhi" delay={0.2} />
              </span>
            </h1>
            <motion.p
            ...
            >
              Kreative Catalyst is a results-driven digital marketing agency based in Delhi. We help businesses across NCR grow their online presence with SEO, social media, paid ads, and more.
            </motion.p>
          </div>
        </section>
        ...
        <section className="py-12 md:py-20 px-4 sm:px-6">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-10 md:mb-16">
              <h2 className="font-heading font-bold text-3xl md:text-4xl lg:text-5xl tracking-tight">
                Why Choose Us <span className="text-gradient">in Delhi?</span>
              </h2>
            </div>
          ...
          <div className="max-w-4xl mx-auto">
            <GlassCard className="p-6 sm:p-10 text-center">
              <h2 className="font-heading font-bold text-2xl md:text-3xl mb-4">
                Our Delhi <span className="text-gradient">Office</span>
              </h2>
        ...
        <section className="py-16 md:py-24 px-4 sm:px-6 text-center">
          ...
          >
            <h2 className="font-heading font-bold text-3xl md:text-4xl mb-4">
              Ready to grow your business <span className="text-gradient">in Delhi?</span>
            </h2>
            <p className="text-light-300/60 mb-8">
              Partner with Kreative Catalyst and take your digital presence to the next level across Delhi and NCR.
            </p>
            <button

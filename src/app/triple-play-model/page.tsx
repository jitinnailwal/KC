...
const triplePlayPillars = [
  {
    ...
    description:
      'Build a strong organic foundation with keyword-optimized content, technical SEO, and authority building. SEO drives long-term, sustainable traffic that compounds over time. As your domain authority grows and content ranks for more keywords, your organic traffic becomes a reliable, cost-free source of high-quality leads that reduces your dependency on paid advertising.',
    icon: (
  ...
  },
  {
    ...
    description:
      'Leverage Facebook and Instagram ads for brand awareness and demand generation. Meta Ads reach users in discovery mode, creating interest before they even search. With advanced audience targeting, lookalike audiences, and retargeting capabilities, Meta Ads introduce your brand to potential customers who match your ideal buyer profile — warming them up for conversion through Search or organic channels.',
    icon: (
      <svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
  ...
  },
  {
    ...
    description:
      'Capture high-intent searches with Google Search and Shopping campaigns. When users are actively looking for your product, Google Ads ensures you\'re right there. By targeting users who are already in buying mode, Google Ads delivers immediate, measurable results with clear ROI — converting the demand generated by Meta Ads and SEO into actual sales and leads.',
    icon: (
      <svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
                ...
                <div>
                  ...
                  <div className="space-y-4 text-light-300/60 leading-relaxed">
                    <p>
                      ...
                      sharing data, audiences, and insights to deliver results that no single channel can achieve alone.
                    </p>
                    <p>
                      Meta Ads generate awareness and demand by putting your brand in front of the right audience.
                      When those users later search for your product or service, Google Ads capture that high-intent traffic
                      and convert it into sales. Meanwhile, SEO builds the long-term organic foundation that steadily
                      reduces your ad dependency and cost per acquisition over time.
                    </p>
                    <p>
                      The result? A self-reinforcing growth loop. As your organic rankings improve, you can reallocate ad
                      budget to scale new audiences. As paid campaigns reveal high-converting keywords and messaging,
                      those insights feed directly into your SEO and content strategy. Every rupee works harder because
                      every channel is informed by the others.
                    </p>
                  </div>
                </div>
                <div className="space-y-4">
                  {[
                    { title: 'Lower Customer Acquisition Cost', desc: 'Multi-channel attribution eliminates wasteful spending — each channel targets the right stage of the buyer journey so you never pay twice for the same conversion.' },
                    { title: 'Compound Growth', desc: 'SEO builds lasting organic equity that appreciates over time, while paid ads deliver immediate revenue — together they create exponential growth.' },
                    { title: 'Full Funnel Coverage', desc: 'Awareness \u2192 Consideration \u2192 Conversion \u2192 Retention' },
                    { title: 'Data Synergies', desc: 'High-performing ad copy informs SEO content. Organic search data reveals new paid keyword opportunities. Each channel continuously sharpens the others.' },
                  ].map((benefit) => (
